		...
		<div class="container">
			<div class="row">
				<div class="col-lg-6">
					...
					<br />
					<br />
					<p><abbr><i>Chi e' pronto a rinunciare alle proprie liberta' fondamentali per comprarsi briciole di temporanea sicurezza non merita ne' la liberta' ne' la sicurezza</i></abbr></p>
